...
Vercel loads the FastAPI application through the `src.index:app` entrypoint in
`pyproject.toml`. Leave Vercel Build Command, Install Command, and Output
Directory unset; Vercel installs dependencies from `pyproject.toml` and
